...
export const TR = {
  ...
  sp_ap: { dmg: 43, heat: 0.05, price: 17 },
  sp_shock: { dmg: 14, heat: 0.4, price: 19, knock: 0.969, cap: 1.93 },
  sp_adhesive: { dmg: 14, heat: 0.4, price: 28, bonus: 64 },
  sp_thermite: { dmg: 2, heat: 1.29, price: 22 },
  sp_marker: { dmg: 16, heat: 0.4, price: 29, vuln: 0.651 },
  sp_chill: { dmg: 129, heat: 0.3, price: 27, slow: 2, cap: 2 },
  sp_cryo: { dmg: 18, heat: 0.15, price: 26, thr: 18, mul: 8.24 },
  sp_purge: { dmg: 256, heat: 0, price: 27, mul: 40 },
  sp_sanctified: { dmg: 26, mult: 6, heat: 0.6, price: 32 },
  sp_cascade: { dmg: 4, mult: 1.2, heat: 4.5, price: 87 },
  sp_breach: { dmg: 341, heat: 0.05, price: 52 },
  sp_solitary: { dmg: 30, heat: 0.3, price: 52, bonus: 285 },
  sp_firststrike: { dmg: 40, heat: 0.1, price: 48, thr: 6, bonus: 269 },
  sp_singularity: { dmg: 20, heat: 0, price: 103, mul: 1.75 },
  sp_judgment: { dmg: 30, heat: 0.5, price: 95, mul: 9.81 },
}
