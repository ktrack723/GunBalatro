 ...
 */
export const TR = {
  sp_incendiary: { dmg: 1, heat: 0.811, price: 17 },
  sp_ap: { dmg: 43, heat: 0.05, price: 16 },
  sp_shock: { dmg: 14, heat: 0.4, price: 19, knock: 0.969, cap: 1.93 },
  sp_adhesive: { dmg: 14, heat: 0.4, price: 27, bonus: 64 },
  sp_thermite: { dmg: 2, heat: 1.29, price: 31 },
  sp_marker: { dmg: 16, heat: 0.4, price: 28, vuln: 0.651 },
  sp_chill: { dmg: 129, heat: 0.3, price: 26, slow: 2, cap: 2 },
  sp_cryo: { dmg: 18, heat: 0.15, price: 15, thr: 18, mul: 65 },
  sp_purge: { dmg: 80, heat: 0, price: 16, mul: 40 },
  sp_sanctified: { dmg: 26, mult: 6, heat: 0.6, price: 30 },
  sp_cascade: { dmg: 4, mult: 1.2, heat: 4.5, price: 241 },
  sp_breach: { dmg: 341, heat: 0.05, price: 51 },
  sp_solitary: { dmg: 30, heat: 0.3, price: 51, bonus: 285 },
  sp_firststrike: { dmg: 40, heat: 0.1, price: 19, thr: 6, bonus: 1760 },
  sp_singularity: { dmg: 20, heat: 0, price: 113, mul: 0.822 },
  sp_judgment: { dmg: 30, heat: 0.5, price: 91, mul: 9.81 },
}
...
export const TA = {
  ...
  br_long: { dmg: 71 },
  br_heavy: { dmg: 159 },
  br_compensator: { dmg: 599, upto: 1 },
  br_bayonet: { dmg: 347, thr: 28 },
  br_catalyst: { dmg: 240 },
  br_gambler: { up: 330, down: 53 },
  br_judgment: { pct: 2.01, max: 8750 },
  br_volatile: { dmg: 227, step: 38, max: 340 },
  br_frostbite: { thr: 6, mul: 102 },
  br_archetype: { pct: 1 },

  // --- 총열덮개 -----------------------------------------------------------
  hg_fin: { heat: 0.173 },
  hg_catalyst: { heat: 0.419 },
  hg_gas: { heat: 0.289, from: 2 },
  hg_relay: { heat: 0.731 },
  hg_chain: { step: 0.135, maxIndex: 4 },
  hg_pyre: { heat: 2.03, burn: 3 },
  hg_cryo: { dmg: 340, thr: 3.5, carry: -0.4 },
  hg_furnace: { heat: 22, thr: 3.5 },
  hg_martyr: { heat: 0.446, step: 0.055, max: 0.557 },
  hg_twoshot: { heat: 4.33, load: 2 },
  hg_inquisition: { heat: 0.789, mult: 1.28 },

  // --- 광학 ---------------------------------------------------------------
  op_laser: { dmg: 97, thr: 20 },
  op_holywater: { heat: 3.05 },
  op_thermal: { dmg: 158, need: 2 },
  op_deferral: { dmg: 461 },
  op_inquest: { dmg: 419 },
  op_lastrites: { heat: 24, thr: 28 },
  op_poverty: { heat: 11 },
  op_trinity: { heat: 0.997, need: 3 },
  op_pact: { dmg: 3397, thr: 4.12 },
  op_quartermaster: { mags: 6 },
  op_soulmark: { heat: 8.39, step: 0.839 },
  op_vigil: { step: 880, max: 5 },
  op_frostvault: { step: 9.51, thr: 6 },
  op_deathrite: { heat: 6.34 },
  op_emperor: { dmg: 94, heat: 2.71 },

  // --- 개머리판 -----------------------------------------------------------
  st_rangefinder: { fireCost: -3 },
  st_fixed: { startDist: 14 },
  st_charm: { brass: 40 },
  st_buffer: { startDist: 12, fireCost: -1 },
  st_penance: { dmg: 343, startDist: -4 },
  st_reliquary: { railSlots: 1, startDist: 16 },
  st_stride: { enemySpeed: -3, startDist: -2 },
  st_bandolier: { start: 1, perMag: 1, max: 6 },
  st_glacier: { dmg: 527, thr: 6, carry: -0.5 },

  // --- 탄창 ---------------------------------------------------------------
  mg_standard: { cap: 5 },
  mg_drum: { cap: 8, heatMul: 0.674 },
  mg_precision: { cap: 3, heat: 0, fireCost: -2 },
  mg_penitent: { cap: 5, heat: 0.183 },
  mg_greed: { cap: 4, keep: 0.553 },
  mg_coolant: { cap: 6, carry: 0.408 },
  mg_executioner: { cap: 2, startHeat: 18, fireCost: -3 },
  mg_annex: { cap: 6, step: 1, max: 6 },
  mg_unstable: { cap: 4, heat: 0.945, carry: -0.25, fuse: 30 },
