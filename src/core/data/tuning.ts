...
export const TA = {
  ...
  br_bayonet: { dmg: 110, thr: 28 },
  br_catalyst: { dmg: 125 },
  br_gambler: { up: 129, down: 21 },
  br_judgment: { pct: 0.732, max: 3181 },
  br_volatile: { dmg: 66, step: 11, max: 98 },
  br_frostbite: { thr: 6, mul: 42 },
  br_archetype: { pct: 1 },

  // --- 총열덮개 -----------------------------------------------------------
  hg_fin: { heat: 0.477 },
  hg_catalyst: { heat: 0.971 },
  hg_gas: { heat: 0.736, from: 2 },
  hg_relay: { heat: 1.44 },
  hg_chain: { step: 0.357, maxIndex: 4 },
  hg_pyre: { heat: 2.57, burn: 3 },
  hg_cryo: { dmg: 122, thr: 3.5, carry: -0.4 },
  hg_furnace: { heat: 15, thr: 3.5 },
  ...
  op_holywater: { heat: 4.15 },
  op_thermal: { dmg: 83, need: 2 },
  op_deferral: { dmg: 138 },
  op_inquest: { dmg: 148 },
  op_lastrites: { heat: 2.02, thr: 28 },
  op_poverty: { heat: 5.55 },
  ...
  mg_unstable: { cap: 4, heat: 1.48, carry: -0.25, fuse: 30 },
